...
CCostume_Festa::CCostume_Festa(std::string GID)
	:CCostumeBase("media/graphic/character/komuk/costume/festa/komuk.png", 0.1, 80, 12, 10, 3.0, 2.0, 20.0, CAttribute(0.9).FLOWER(1.5).AQUA(1.32), COF(0.5, 0.5, 0.05, 0.0), GID)
{
