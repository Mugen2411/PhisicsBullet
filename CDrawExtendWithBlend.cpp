...
CDrawExtendWithBlendReserve::CDrawExtendWithBlendReserve(int GHandle, double Priority, float x1, float y1, float x2, float y2, int color, int Blendmode, int value)
