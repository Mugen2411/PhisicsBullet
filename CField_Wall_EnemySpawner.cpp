...
CField_Wall_EnemySpawner::CField_Wall_EnemySpawner(std::string gid, CVector position, int index)
	:CField(gid, position, CVector(32,32), COF(0,0,0,0), 0), index(index), CND()
{
}
