...
CField_Wall_PlayerSpawner::CField_Wall_PlayerSpawner(std::string gid, CVector position)
...
{
	CImageManager::getIns().find("player_komuk")->DrawRota(Position.x, Position.y, 0, 1, Constant::priority_enemy, 4);
}
