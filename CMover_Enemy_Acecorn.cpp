...
CMover_Enemy_Acecorn::CMover_Enemy_Acecorn(CVector position, int Level) :
	CMover_EnemyBase(30, Level, 1.35, 3.2, CAttribute(1.0).FIRE(0.5).FLOWER(3.0).AQUA(0.8), 80, 0xFF7F00, position, 4.8, 2.4, COF(0.8, 0.95, 0.06, 0.1)),
...
void CMover_Enemy_Acecorn::Render() const
{
	...
	CImageManager::getIns().find("enemy_acecorn")->DrawRota(Position.x, Position.y, 0.0, 1.0, Constant::priority_enemy, Direction * 4 + (int)(animCount));
}
