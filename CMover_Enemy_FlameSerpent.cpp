...
void CMover_Enemy_FlameSerpent::Render() const
{
	...
	CImageManager::getIns().find("enemy_flameserpent")->DrawRota(Position.x, Position.y, 0.0, 1.0, Constant::priority_enemy, Direction * 4 + (int)(animCount));
}

CMover_EnemyBase* CMover_Enemy_FlameSerpent::Clone(CVector Position, int Level)
{
