...
CMover_Shot_Archer_FlameArrow::CMover_Shot_Archer_FlameArrow(CAttribute baseATK, CVector position, double angle)
	:CMover_ShotBase(baseATK, CAttribute(0.0).NONE(30).FIRE(30), position, 18, CVector(angle) * 32.0, 0.2, COF(0.0, 0.5, 0.15, 0.0), 0xFF0000)
{
}
