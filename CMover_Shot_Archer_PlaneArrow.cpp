...
CMover_Shot_Archer_PlaneArrow::CMover_Shot_Archer_PlaneArrow(CAttribute baseATK, CVector position, double angle)
...
{
	CImageManager::getIns().find("shot_archer_arrow")->DrawRotaF(Position.x, Position.y, Velocity.getAngle(), 1.0, Constant::priority_shot, 0);
}
